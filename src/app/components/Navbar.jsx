...
const Navbar = () => {
    ...
    return (
        <nav
            className="flex items-center justify-between w-full relative px-6 py-4">

            {/* logo */}
            <Link href="/"><img src="https://i.ibb.co.com/rK6KHcNd/g-rentify.png" alt="logo" className="w-[155px] "/></Link>
            ...
            <ul className="items-center gap-[20px] text-[1rem] text-[#424242] md:flex hidden">
                ...
                <li className={`${isProductHover ? "text-[#3B9DF8]" : "dark:text-[#abc2d3] text-gray-600"} flex items-center gap-[5px] cursor-pointer`}
                    ...
                    {/* mega menu */}
                    <div
                        className={`${isProductHover ? "translate-y-0 opacity-100 z-30" : "translate-y-[20px] opacity-0 z-[-1]"} bg-white rounded-md w-full absolute top-[60px] left-[20%] p-[30px] transition-all duration-300 boxShadow flex flex-wrap gap-[30px]`}>
            ...
            <div className="flex items-center gap-[15px]">
                <div className="flex items-center gap-[10px] cursor-pointer relative"
                    ...
                    <h1 className="text-[1rem] font-[400] text-gray-600 sm:block hidden">Mika Sing</h1>
